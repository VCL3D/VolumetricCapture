...
It is also possible to connect and calibrate `K` devices, with `N >= 3`. Just follow all the standard steps (described above and in Section [Volumetric Capture](../volcap)).
