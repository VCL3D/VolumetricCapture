...
<img src="rabbitmq_user.gif" alt="Description" width="800">
...
<img src="firewall.gif" alt="Description" width="800">
...
<img src="connected.png" alt="Description" width="850">

## Calibration Instructions

<img src="calibration.png" alt="Description" width="400">
...
<img src="boxes.png" alt="Description" width="400">
...
2. **Troubleshooting**
   ...
   <img src="calibration_example.png" alt="Calibration error example" width="400">
   ...
   <img src="calibration_evaluation.gif" alt="False calibration example" width="850">
...
1. **Hardware Setup**
   ...
   <img src="audio.gif" alt="False calibration example" width="600">
...
<img src="reconstruction.gif" alt="False calibration example" width="850">
...
<img src="stream.gif" alt="False calibration example" width="850">
